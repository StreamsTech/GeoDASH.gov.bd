...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('services', '__first__'),
        ('groups', '0002_auto_20180130_0637'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abstract_en', models.TextField(default=b'Abstract is very important! You are requested to update it now.', help_text='brief narrative summary of the content of the resource(s)', null=True, verbose_name='abstract', blank=True)),
